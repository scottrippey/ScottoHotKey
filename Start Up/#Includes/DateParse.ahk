...
*   /
DateParse(str) {
MSGBOX This function is only configured to work with "British" dates, and not US dates.  Day and Month will be switched.
	static e2 = "i)(?:(\d{1,2}+)[\s\.\-\/,]+)?(\d{1,2}|(?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\w*)[\s\.\-\/,]+(\d{2,4})"
	str := RegExReplace(str, "((?:Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\w*)(\s*)(\d{1,2})\b", "$3$2$1", "", 1)
