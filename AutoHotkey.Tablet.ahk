	...
	SetButtonNames("AutoInclude", "&Dual", "&Single")
	MsgBox, 0x1024, AutoInclude, What monitor configuration are you using?  Single-Monitor or Dual-Monitor?
	IfMsgBox Yes
	...
	SetWorkingDir C:\My Docs\Utilities\AutoHotKey\Start Up
	#Include      C:\My Docs\Utilities\AutoHotKey\Start Up
